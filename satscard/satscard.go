...
func SignTransaction(info *data.AddressInfo, transaction *data.RawSlotSweepTransaction, privateKeyBytes []byte) (*data.TransactionDetails, error) {
	...
	key, _ := btcec.PrivKeyFromBytes(privateKeyBytes)
